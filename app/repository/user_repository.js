...
class UserRepository {
    ...
    async getUserIdByEmail(email) {
        try {
            ...
            logger.error(`Error occurred while retrieving User data for email: ${email}`, err);
            throw new Error(`Error occurred while retrieving User data for email: ${email}`, err);
        }
    }
}
